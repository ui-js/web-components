...
Context Menu elements are screen reader compatible: the various components of a menu are labeled with the appropriate ARIA attributes.

### Theming

Context Menu support dark and light mode.
...
If using Javascript, you can also add it with
...
A context menu can be styled and customized using `::part()` selectors
